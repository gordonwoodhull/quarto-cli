  ...
  tests:
    ...
    typst:
      ensureTypstFileRegexMatches:
        -
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, \\[ \\$ E = m c\\^2 \\$ \\]\\)<eq-display-math>"
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, alt: \"Einsteins mass-energy equivalence equation\", \\[ \\$ E = m c\\^2 \\$ \\]\\)<eq-display-alt>"
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, alt: \"Einsteins mass-energy equivalence equation\", \\[ \\$ E = m c\\^2 \\$ \\]\\)<eq-display-alt-spaces>"
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, alt: \"Newton's second law of motion\", \\[ \\$ F = m a \\$ \\]\\)<eq-single-quote>"
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, alt: \"The \\\\\"Pythagorean\\\\\" theorem\", \\[ \\$ a\\^2 \\+ b\\^2 = c\\^2 \\$ \\]\\)<eq-double-quote>"
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, alt: \"This is using \\\\\"quotes\\\\\" but I'm sure it works\", \\[ \\$ x \\+ y = z \\$ \\]\\)<eq-mixed-quotes>"
          - "#math\\.equation\\(block: true, numbering: quarto-equation-numbering, alt: \"This is using 'single quotes' around the \\\\\"quotes\\\\\" but I'm sure it works\", \\[ \\$ x \\+ y = z \\$ \\]\\)<eq-single-quote-alt>"
        - []
---
